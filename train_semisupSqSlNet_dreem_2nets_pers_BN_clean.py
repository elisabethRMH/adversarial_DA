            ...
            with sess.as_default():
                ...
                for epoch in range(config.training_epoch):
                    ...
                    while step < train_batches_per_epoch:
                        ...
                        if config.withtargetlabels: #NOT used for personalization
                            # labeled target data: labeled data of 1 patient
                            (x_batch2,y_batch2)=retrain_generator[step]
                            x_batch2=x_batch2[:,:,:,:,[config.channel, config.channel]]
